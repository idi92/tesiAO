...
class MemsReconstructor(object):
    ...
    def _check_input_mask(self):
        '''
        Checks cmask dimensions and
        Returns True if cmask is fully inscribed in the ifs mask
        '''
    ...
    def _normalize_influence_function(self):
        self._normalized_ifs = 0.5 * self._ifs / self._ifs_stroke

    def _build_interaction_matrix(self):
        self._im = np.column_stack([self._normalized_ifs[act]
